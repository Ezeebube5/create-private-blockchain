...
class Blockchain {
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            // Create the block and add it to the chain and resolve with the block added
    ...
    validateChain() {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            this.chain.map(async (b) => {
                ...
                if (!validBlock) errorArray.push(`Block ${b.hash} is invalid!`)
                if ( previousBlock && previousBlock.hash != b.previousBlockHash ) errorArray.push(`${previousBlock.hash} is not the previous block!`)
                previousBlock = b
            })
            resolve(errorArray)
        });
